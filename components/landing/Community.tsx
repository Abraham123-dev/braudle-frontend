  ...
  <section id="community" className="py-24 px-8 max-w-7xl mx-auto scroll-mt-20">
    <div className="grid lg:grid-cols-2 gap-24 items-center">
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="aspect-[4/5] rounded-[24px] bg-brand-green p-8 flex flex-col justify-center gap-4 text-white">
        ...
        <div className="aspect-[4/5] rounded-[24px] bg-brand-lime p-8 flex flex-col justify-end">
          <h2 className="text-4xl lg:text-5xl font-semibold text-brand-green tracking-tighter">94%</h2>
          <p className="text-[10px] font-medium text-brand-green uppercase tracking-[0.2em] mt-2 leading-tight">Study Efficiency <br /> Increase</p>
        </div>
        <div className="aspect-[4/5] rounded-[24px] bg-gray-200 overflow-hidden">
        ...
        <div className="space-y-10">
          {[
            ...
            <div key={i} className="flex gap-6">
              <div className="w-14 h-14 rounded-full bg-gray-100 shrink-0 border border-gray-50" />
              <div className="space-y-2">
                <p className="text-gray-600 italic font-normal text-[15px]">"{item.text}"</p>
                <p className="text-brand-green font-medium flex flex-wrap gap-2 text-[13px]">
