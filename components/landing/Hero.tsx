...
export const Hero = () => (
  <section className="pt-20 lg:pt-32 pb-12 md:pb-24 px-8 max-w-7xl mx-auto">
    <div className="grid lg:grid-cols-2 items-center gap-12 lg:gap-16 lg:text-left text-center">
      <div className="space-y-6 md:space-y-10">
        <div className="space-y-4 md:space-y-6">
          <span className="text-[10px] md:text-[11px] font-medium uppercase tracking-[0.2em] text-gray-400 block">For Students & Self-Learners</span>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] font-semibold text-brand-forest leading-[1.1] md:leading-[1.05] tracking-tight flex flex-wrap lg:justify-start justify-center items-center gap-x-3 md:gap-x-4">
            Master any subject
            <span className="inline-flex items-center gap-2 px-4 md:px-6 py-1.5 md:py-2 bg-brand-lime rounded-full text-brand-forest text-xl sm:text-2xl lg:text-4xl">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-10 lg:h-10">
        ...
        <p className="text-sm md:text-base lg:text-[17px] text-gray-500/80 max-w-xl lg:mx-0 mx-auto leading-relaxed font-normal px-4 lg:px-0">
        ...
        <div className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-4 px-4 sm:px-0">
          <Link href="/login" className="w-full sm:w-auto px-7 py-3.5 bg-brand-green text-white rounded-full font-medium text-[15px] hover:bg-brand-forest transition-colors whitespace-nowrap text-center">
            Get Started Free
          </Link>
          <Link href="#how-it-works" className="w-full sm:w-auto px-7 py-3.5 bg-gray-50 text-gray-600 rounded-full font-medium text-[15px] hover:bg-gray-100 transition-colors text-center whitespace-nowrap">
            Learn more
          </Link>
        </div>
        
        <div className="flex items-center lg:justify-start justify-center gap-3 text-[12px] md:text-[13px] text-gray-400 font-normal pt-2">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="show"
        className="grid grid-cols-2 gap-3 md:gap-4 w-full h-[500px] sm:h-[600px] md:h-[500px] lg:h-[600px] mt-8 lg:mt-0"
      >
        ...
        >
          ...
          <Link href="/login" className="relative z-10 w-12 h-12 rounded-full bg-brand-green text-white flex items-center justify-center transition-transform shadow-lg shadow-brand-green/20">
