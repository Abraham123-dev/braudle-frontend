             ...
             <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
              <div className="space-y-6 max-w-lg">
                ...
                <div className="pt-2 flex justify-center md:justify-start">
                  <Link href="/login" className="w-full sm:w-auto px-8 py-3.5 bg-brand-forest text-white font-medium text-[15px] rounded-xl hover:bg-brand-green transition-colors active:opacity-90 text-center">
                    Try for free
                  </Link>
                </div>
              </div>
              ...
              <div className="relative w-full max-w-xs aspect-[4/3] flex items-center justify-center">
                <style jsx>{`
                  ...
                  .avatar { width: 60px; height: 75px; border: 3px solid #013220; border-radius: 30px 30px 8px 8px; background: transparent; position: relative; }
                  .avatar::after { content: ''; position: absolute; top: 15px; left: 15px; width: 30px; height: 30px; border-top: 3px solid #013220; border-radius: 50%; }
                `}</style>
